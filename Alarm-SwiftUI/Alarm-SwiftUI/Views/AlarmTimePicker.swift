...
//  Alarm-SwiftUI
//
//  Created by RMP on 13/04/1446 AH.
//
...
struct AlarmTimePicker_Previews: PreviewProvider {
    static var previews: some View {
        AlarmTimePicker(isSetAlarm: .constant(false), alarmTime: .constant("4:30"), dateCompo: .constant(Calendar.current.dateComponents([.hour, .minute, .second], from: Date.now)))
    }
}
