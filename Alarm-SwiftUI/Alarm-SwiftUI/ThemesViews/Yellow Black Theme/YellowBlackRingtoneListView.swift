//
//  YellowBlackRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct YellowBlackRingtoneListView: View {
        ...
        ZStack {
            ...
            List {
                ...
                ForEach($ringtones, id: \.id) { $index in
                            ...
                            Button {
                                ...
                                if let lastElement = lastElementYouClickedOn.last {
                                    ...
                                    if lastElement == index.id {
                                        ...
                                        Image(systemName: index.isPlay ? "pause.fill" : "play.fill").tint(.black)
                                        
                                    } else {
                                        
                                        Image(systemName: "play.fill").tint(.black)
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color(uiColor: UIColor.black)).listRowBackground(Color.yellow)
            ...
            ToolbarItem(placement: .navigationBarLeading) {
                ...
                Button {
                    ...
                    Image(systemName: "chevron.left").font(.title2).foregroundColor(.black).shadow(color: .blue, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0)
                }
...
struct YellowBlackRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        YellowBlackRingtoneListView()
    }
}
