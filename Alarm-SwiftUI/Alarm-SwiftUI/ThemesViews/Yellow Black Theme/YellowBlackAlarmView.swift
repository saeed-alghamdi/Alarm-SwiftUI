...
struct YellowBlackAlarmView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Text(currentAmPm).foregroundColor(.black).padding(.top, 120).font(.custom("digital-7", size: 70)).shadow(color: .yellow, radius: 5, x: 0, y: 0).shadow(color: .yellow, radius: 5, x: 0, y: 0).shadow(color: .yellow, radius: 5, x: 0, y: 0).padding()
                    Text(myCurrentTime).foregroundColor(.black).font(.custom("digital-7", size: 250)).shadow(color: .yellow, radius: 7, x: 0, y: 0).shadow(color: .yellow, radius: 8, x: 0, y: 0).shadow(color: .yellow, radius: 8, x: 0, y: 0)
                    ...
                    }.padding(.leading, 30).foregroundColor(.black).shadow(color: .yellow, radius: 7, x: 0, y: 0).shadow(color: .yellow, radius: 8, x: 0, y: 0).shadow(color: .yellow, radius: 8, x: 0, y: 0).opacity(isSetAlarm ? 1.0 : 0.0).onTapGesture {
                    ...
                    YellowBlackAlarmTimePicker(isSetAlarm: $isSetAlarm, alarmTime: $alarmTime, dateCompo: $dateCompo)
...
struct YellowBlackAlarmView_Previews: PreviewProvider {
