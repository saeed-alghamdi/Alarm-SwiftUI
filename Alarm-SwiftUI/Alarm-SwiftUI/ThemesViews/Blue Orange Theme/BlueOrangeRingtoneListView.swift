//
//  BlueOrangeRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct BlueOrangeRingtoneListView: View {
        ...
        ZStack {
                ...
                ForEach($ringtones, id: \.id) { $index in
                    ...
                    VStack {
                        ...
                        HStack {
                            ...
                            Button {
                                ...
                                if let lastElement = lastElementYouClickedOn.last {
                                    ...
                                    if lastElement == index.id {
                                        ...
                                        Image(systemName: index.isPlay ? "pause.fill" : "play.fill").tint(.blue)
                                        
                                    } else {
                                        
                                        Image(systemName: "play.fill").tint(.blue)
                            ...
                            Text(index.name).foregroundColor(.blue)
                            ...
                            Button {
                                ...
                                if let lastElement = lastElementYouChoose.last {
                                    ...
                                    if lastElement == index.id {
                                        ...
                                        Image(systemName: "checkmark").tint(.blue)
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color.blue).listRowBackground(Color.orange)
            ...
            ToolbarItem(placement: .navigationBarLeading) {
                ...
                Button {
                    ...
                    Image(systemName: "chevron.left").font(.title2).foregroundColor(.blue).shadow(color: .yellow, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0).shadow(color: .yellow, radius: 9, x: 0, y: 0)
...
struct BlueOrangeRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        BlueOrangeRingtoneListView()
    }
}
