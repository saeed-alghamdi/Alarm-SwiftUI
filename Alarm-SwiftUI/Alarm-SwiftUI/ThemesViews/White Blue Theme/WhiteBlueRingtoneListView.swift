//
//  WhiteBlueRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct WhiteBlueRingtoneListView: View {
        ...
        ZStack {
            ...
            List {
                ...
                ForEach($ringtones, id: \.id) { $index in
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color.blue).listRowBackground(Color.white)
...
struct WhiteBlueRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        WhiteBlueRingtoneListView()
    }
}
