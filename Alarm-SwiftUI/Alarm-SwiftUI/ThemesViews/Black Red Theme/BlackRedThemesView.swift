...
struct BlackRedThemesView: View {
    ...
    @State var toastMessageForgroundColor: Color = .black
    ...
    var body: some View {
        ...
        ZStack {
            ...
            List {
                ...
                }.listRowSeparatorTint(Color.black).listRowBackground(Color.red)
...
struct BlackRedThemesView_Previews: PreviewProvider {
