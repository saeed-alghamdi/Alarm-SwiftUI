//
//  BlackRedRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct BlackRedRingtoneListView: View {
        ...
        ZStack {
            ...
            List {
                ...
                ForEach($ringtones, id: \.id) { $index in
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color(uiColor: UIColor.black)).listRowBackground(Color(red: 234 / 255, green: 77 / 255, blue: 60 / 255))
...
struct BlackRedRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        BlackRedRingtoneListView()
    }
}
