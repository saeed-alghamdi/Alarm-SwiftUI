...
struct WhiteMintThemesView: View {
    ...
    @State var toastMessageShadowColor: Color = .mint
    ...
    var body: some View {
        ...
        ZStack {
            ...
            List {
                ...
                }.listRowSeparatorTint(Color.white).listRowBackground(Color.mint)
...
struct WhiteMintThemesView_Previews: PreviewProvider {
