...
struct DefaultThemeThemesView: View {
    ...
    @State var toastMessageShadowColor: Color = .black
...
struct DefaultThemeThemesView_Previews: PreviewProvider {
    static var previews: some View {
        DefaultThemeThemesView()
    }
}
