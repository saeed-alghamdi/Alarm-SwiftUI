//
//  DefaultThemeRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct DefaultThemeRingtoneListView: View {
        ...
        ZStack {
            ...
            List {
                ...
                ForEach($ringtones, id: \.id) { $index in
                            ...
                            Button {
                                ...
                                if let lastElement = lastElementYouClickedOn.last {
                                    ...
                                    if lastElement == index.id {
                                        ...
                                        Image(systemName: index.isPlay ? "pause.fill" : "play.fill").tint(.white)
                                        
                                    } else {
                                        
                                        Image(systemName: "play.fill").tint(.white)
                            ...
                            Button {
                                ...
                                if let lastElement = lastElementYouChoose.last {
                                    ...
                                    if lastElement == index.id {
                                        ...
                                        Image(systemName: "checkmark").tint(.yellow)
                                        
                                    } else {
                                        
                                        Image(systemName: "checkmark").tint(.gray)
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color(uiColor: UIColor.systemGray)).listRowBackground(Color(red: 28 / 255, green: 27 / 255, blue: 29 / 255))
...
struct DefaultThemeRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        DefaultThemeRingtoneListView()
    }
}
