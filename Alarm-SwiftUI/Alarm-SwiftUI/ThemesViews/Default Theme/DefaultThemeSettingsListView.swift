//
//  DefaultThemeSettingsListView.swift
//  Alarm-SwiftUI
//
...
struct DefaultThemeSettingsListView: View {
...
struct DefaultThemeSettingsListView_Previews: PreviewProvider {
    static var previews: some View {
        DefaultThemeSettingsListView()
    }
}
