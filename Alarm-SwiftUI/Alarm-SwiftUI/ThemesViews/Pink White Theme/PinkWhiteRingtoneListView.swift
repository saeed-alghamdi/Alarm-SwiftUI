//
//  PinkWhiteRingtoneListView.swift
//  Alarm-SwiftUI
//
...
struct PinkWhiteRingtoneListView: View {
        ...
        ZStack {
            ...
            List {
                ...
                ForEach($ringtones, id: \.id) { $index in
                    ...
                    }.padding([.bottom, .top], 8).listRowSeparatorTint(Color.white).listRowBackground(Color.pink)
...
struct PinkWhiteRingtoneListView_Previews: PreviewProvider {
    static var previews: some View {
        PinkWhiteRingtoneListView()
    }
}
