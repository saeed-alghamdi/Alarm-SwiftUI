...
struct PinkWhiteThemesView: View {
    ...
    @State var toastMessageShadowColor: Color = .pink
            ...
            List {
                ...
                ToolbarItem(placement: .navigationBarLeading) {
                    ...
                    Button {
                        ...
                        Image(systemName: "chevron.left").font(.title2).foregroundColor(.pink).shadow(color: .blue, radius: 9, x: 0, y: 0)
...
struct PinkWhiteThemesView_Previews: PreviewProvider {
