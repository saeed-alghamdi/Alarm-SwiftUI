...
struct PinkWhiteAlarmView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Text(currentAmPm).foregroundColor(.pink).padding(.top, 120).font(.custom("digital-7", size: 70)).shadow(color: .black, radius: 5, x: 0, y: 0).shadow(color: .black, radius: 5, x: 0, y: 0).shadow(color: .black, radius: 5, x: 0, y: 0).padding()
                    Text(myCurrentTime).foregroundColor(.pink).font(.custom("digital-7", size: 250)).shadow(color: .black, radius: 7, x: 0, y: 0).shadow(color: .black, radius: 8, x: 0, y: 0).shadow(color: .black, radius: 8, x: 0, y: 0)
                    ...
                    }.padding(.leading, 30).foregroundColor(.pink).shadow(color: .black, radius: 7, x: 0, y: 0).shadow(color: .black, radius: 8, x: 0, y: 0).shadow(color: .black, radius: 8, x: 0, y: 0).opacity(isSetAlarm ? 1.0 : 0.0).onTapGesture {
                    ...
                    PinkWhiteAlarmTimePickerView(isSetAlarm: $isSetAlarm, alarmTime: $alarmTime, dateCompo: $dateCompo)
...
struct PinkWhiteAlarmView_Previews: PreviewProvider {
